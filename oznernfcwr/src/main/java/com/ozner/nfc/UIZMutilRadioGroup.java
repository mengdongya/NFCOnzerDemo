...
/**
 * Created by ozner_67 on 2016/10/31.
 * 邮箱：xinde.zhang@cftcn.com
 */

public class UIZMutilRadioGroup extends LinearLayout {
    ...
    public UIZMutilRadioGroup(Context context) {
        super(context);
        setOrientation(VERTICAL);
        init();
    }

    public UIZMutilRadioGroup(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    public LayoutParams generateLayoutParams(AttributeSet attrs) {
        return new UIZMutilRadioGroup.LayoutParams(getContext(), attrs);
    }
    ...
    protected boolean checkLayoutParams(ViewGroup.LayoutParams p) {
        return p instanceof UIZMutilRadioGroup.LayoutParams;
    }
    ...
    public void onInitializeAccessibilityEvent(AccessibilityEvent event) {
        ...
        event.setClassName(UIZMutilRadioGroup.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(UIZMutilRadioGroup.class.getName());
    }
    ...
    public interface OnCheckedChangeListener {
         ...
         */
        public void onCheckedChanged(UIZMutilRadioGroup group, int checkedId);
    }
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == UIZMutilRadioGroup.this ) {
                List<RadioButton> btns = getAllRadioButton(child);
                if(btns != null && btns.size() > 0){
